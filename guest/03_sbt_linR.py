...
from pipeline.component import Evaluation, Union
...
def main(config="config.yaml", namespace="seed2022"):
    ...
    host_train_data = {
        ...
        "namespace": namespace,
        'path': str(data_base / f"output/002_power_data_train{suffix}.csv")
    }
    ...
    host_test_data = {
        ...
        "namespace": namespace,
        'path': str(data_base / f"output/002_power_data_test{suffix}.csv")
    }
    ...
    host_valid_data = {
        ...
        "namespace": namespace,
        'path': str(data_base / f"output/002_power_data_valid{suffix}.csv")
    }
    ...
    # save
    pipeline.dump(f"output/model/sbt_lr{suffix}.pkl")
    ...
    if predict:
        ...
        predict_result.to_csv('output/003_result.csv')
